...
mod logic {
    ...
    pub fn begin_play() {
        { let node_a0bdff47_956d_4174_bd8b_b74fb1b8b2ab_result = print_number (0.0) ; } { let node_abbfaa66_9729_4fdd_bf1b_5bd471464ff2_result = print_number (0.0) ; } { let node_4429dec8_233f_4e50_95b9_77a2032dbf40_result = println (String :: new ()) ; } { { { let node_f3943088_1597_4a1c_8558_7a31a26b2c92_result = print_formatted (String :: new () , String :: new () , String :: new () , String :: new ()) ; } { } { let node_6b228e95_aba9_497f_b61d_d94e80465f88_result = print_bool (false) ; } { } } { let node_aef3fdca_6992_48a7_b16d_651ed2733547_result = print_number (0.0) ; } { } { } }
    }
